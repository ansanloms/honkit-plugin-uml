...
test("replace with ascii format", async () => {
  ...
  expect(
    await blocks.uml.process({
      body: umlDataForAscii,
    })
  ).toEqual(resultAscii);
});
